...
//       $keyword = 'aa';
//        $res = $this->sphinx->Query("\"{$keyword}\"/{$matchLength}",'teaseb_total');
        $res = $this->sphinx->Query("{$keyword}",'teaseb_total');
//        dump($this->sphinx);die;
        return $res;
     ...
     * @groupby array("did","@count desc");
     */
    public  function getCategorySellGroupBy($catid,$limit,$groupby,$orderby,$conditions=null){
        ...
        $res = $this->sphinx->Query('','teaseb_total');
        return $res;
